  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="hidden lg:col-span-4 lg:flex flex-col gap-4 border-l border-[#e8e8df] pl-8 pt-12 text-xs font-mono text-gray-500">
          <div>
      ...
      <div className="mb-24 grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-16">
      ...
      <div className="mb-24 grid grid-cols-1 gap-8 rounded-3xl bg-[#fbfbf6] border border-[#e8e8df]/70 p-8 md:p-12 lg:grid-cols-3 shadow-[0_4px_24px_rgba(0,0,0,0.015)]">
        <div className="flex items-start gap-4">
          <div className="rounded-2xl bg-white p-3 shadow-xs border border-[#e8e8df] text-[#5a5a40]">
            <Landmark className="h-5 w-5" />
          </div>
          <div>
            <h4 className="font-display font-bold text-[#1a1a1a]">
              Aesthetic Authenticity
            </h4>
            <p className="mt-1.5 text-xs text-gray-600 leading-relaxed">
              We reject current cookie-cutter patterns and build from
              mathematical grid structures, timeless Swiss layouts, and
              meticulous spacing ratios.
            </p>
          </div>
        </div>
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="mt-1.5 text-xs text-gray-600 leading-relaxed">
              Every interface we deliver is highly reactive, lightweight, search
              optimized, and built utilizing advanced modern React techniques.
            </p>
          </div>
        </div>
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="mt-1.5 text-xs text-gray-600 leading-relaxed">
              We translate abstract structural concepts and brand philosophies
              into tactile online installations that spark engagement.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="relative overflow-hidden rounded-3xl bg-[#1a1a1a] px-8 py-16 text-center text-white md:px-16 md:py-24">
        ...
        <button
          ...
          className="mt-10 cursor-pointer rounded-full bg-white px-8 py-3 text-xs font-bold uppercase tracking-widest text-[#1a1a1a] transition-all hover:bg-[#5a5a40] hover:text-white"
        >
          Get In Touch
        </button>
      </div>
